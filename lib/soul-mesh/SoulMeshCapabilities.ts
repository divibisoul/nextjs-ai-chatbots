...
{id:'octacore.execute',version:'1.0',description:'Octacore execution wrapper over the existing N04 processor runtime.',request:true,response:true,events:false,remote:true,owner:'N04'},
