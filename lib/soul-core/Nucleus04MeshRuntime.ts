...
function message(capability: string, payload: unknown): SoulMeshMessage { return { protocol: 'soul-mesh/1', version: '1.1.0', id: crypto.randomUUID(), correlationId: crypto.randomUUID(), source: 'N04', target: 'N04', kind: 'request', capability, payload, timestamp: Date.now() } as SoulMeshMessage; }
